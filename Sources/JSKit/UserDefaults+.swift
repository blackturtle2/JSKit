...
extension UserDefaults {
    ...
    public class func standardSet<Element: Codable>(_ value: Element, with key: String) {
    ...
    public class func set<Element: Codable>(_ value: Element, with key: String, in appGroup: String) {
        let encoded = try? JSONEncoder().encode(value)
